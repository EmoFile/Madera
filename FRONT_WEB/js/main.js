    ...
    bind() {
        $('#creation-devis').click(function () {
            ...
            $('#valider-devis').click(function () {
                ...
                devisJSON["client"] = document.getElementById('select-client').value
                devisJSON["commercial"] = session["id_erp"]
    ...
    $('#login').click(function () {
        ...
        $('#connexionButton').click(function () {
            ...
            $.ajax({
                ...
                if ('Client' === session["departement"]) {
                    $navDiv.append($buttonHome)
                }
                if ('Commercial' === session["departement"]) {
                    $navDiv.append($buttonHome)
                    $navDiv.append($buttonCreationDevis)
                }
                if ('BE' === session["departement"]) {
                    $navDiv.append($buttonHome)
                }
                if ('IT' === session["departement"]) {
                    $navDiv.append($buttonCreationCompteInterne)
                }
                if ('Administrator' === session["departement"]) {
                    $navDiv.append($buttonVueBI)
                }
                BIBTN.bind()
                HOMEBTN.bind()
                CREATIONDEVISBTN.bind()
                CREATIONUSERINTERNEBTN.bind()
            }).fail(function (msg, status, jqXHR) {
                console.log('fail')
                console.log(msg)
                console.log(status)
